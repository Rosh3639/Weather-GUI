...
from main_helper import get_temperature

degree_sign = u'\N{DEGREE SIGN}'


def init_plot():
    plt.figure('Open Weather', figsize=(5, 4))
    plt.xlabel('Day')
...
def plot_temperatures(days, temp_min, temp_max):
    ...
    bar_min = plt.bar(days - .25, temp_min, width=0.5, color='#e58510')
    bar_max = plt.bar(days + .25, temp_max, width=0.5, color='black')
